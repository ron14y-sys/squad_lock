...
**A5's eval runner will score a correct A3 as wrong on scenario 06 until this is fixed**, and the tempting "fix" is to bend the distance function toward road distance — exactly what the §5.4 warning forbids.
